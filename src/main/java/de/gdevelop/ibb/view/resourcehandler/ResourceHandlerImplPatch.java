package de.gdevelop.ibb.view.resourcehandler;
 ...
 * "WARNING JSF1064: Unable to find or serve resource from library, ibb/composites"
 */
public class ResourceHandlerImplPatch extends DefaultResourceHandler {

	private static final String COMPOSITE_LIBRARY_NAME = "ibb/composites";
